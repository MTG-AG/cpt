...
/**
 *
 * Instances of this class represent the AuthorityInformationAccess extension.
 *
 */
public class AuthorityInformationAccess extends XMLExtension
{

    private static Logger logger = LoggerFactory.getLogger(AuthorityInformationAccess.class);

    /**
     *
     * Constructs an AuthorityInformationAccess extension from its XML representation specified in this xmlExtension.
     ...
     */
    public AuthorityInformationAccess(de.mtg.certpathtest.pkiobjects.Extension xmlExtension) throws WrongPKIObjectException,
                                                                                             IOException
    {
        super(xmlExtension);
        validate();
