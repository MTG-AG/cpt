...
public class ObjectCache
{
    ...
    private ConcurrentHashMap<String, Certificate> certificates = new ConcurrentHashMap<String, Certificate>();
    private ConcurrentHashMap<String, TestCase> testCases = new ConcurrentHashMap<String, TestCase>();
    private ConcurrentHashMap<String, CRL> crls = new ConcurrentHashMap<String, CRL>();
    private ConcurrentHashMap<String, PrivateKey> privateKeys = new ConcurrentHashMap<String, PrivateKey>();
    private ConcurrentHashMap<String, byte[]> publicKeys = new ConcurrentHashMap<String, byte[]>();
    private ConcurrentHashMap<String, byte[]> rawCertificates = new ConcurrentHashMap<String, byte[]>();
    private ConcurrentHashMap<String, byte[]> rawCrls = new ConcurrentHashMap<String, byte[]>();
    private ConcurrentHashMap<String, PKIObjects> testCasePKIObjects = new ConcurrentHashMap<String, PKIObjects>();

    // TestCase mapping to Certificate
    private ConcurrentHashMap<String, List<String>> testCaseToCertificateMap =
        new ConcurrentHashMap<String, List<String>>();

    // TestCase mapping to CRL
    private ConcurrentHashMap<String, List<String>> testCaseToCRLMap = new ConcurrentHashMap<String, List<String>>();

    // Certificate mapping to TestCase
    private ConcurrentHashMap<String, String> certificateToTestCaseMap = new ConcurrentHashMap<String, String>();

    // CRL mapping to TestCase
    private ConcurrentHashMap<String, String> crlToTestCaseMap = new ConcurrentHashMap<String, String>();

    // certificate in key is signed by certificate in value
    private ConcurrentHashMap<String, String> certificateIssuerMap = new ConcurrentHashMap<String, String>();

    // mapping of HTTP CRL DPs to CRLs
    private ConcurrentHashMap<String, String> httpCRLDPs = new ConcurrentHashMap<String, String>();

    private ConcurrentHashMap<String, String> ldapCRLDPs = new ConcurrentHashMap<String, String>();

    private List<String> errors = new ArrayList<String>();

    private ConcurrentHashMap<String, String> serialNumbers = new ConcurrentHashMap<String, String>();

    private String archiveTimestamp = new String();

    private List<String> ldapEntries = new ArrayList<String>();
    ...
    public void assignCertificateIdToTestCase(TestCase testCase, Certificate certificate)
    {
        ...
        {
            certificateIdList = new ArrayList<String>();
    ...
    public void assignCRLIdToTestCase(TestCase testCase, CRL crl)
    {
        ...
        List<String> crlIdList = (List<String>) testCaseToCRLMap.get(testCaseId);

        if (crlIdList == null)
        {
            crlIdList = new ArrayList<String>();
            crlIdList.add(crlId);
        }
        else
        {
